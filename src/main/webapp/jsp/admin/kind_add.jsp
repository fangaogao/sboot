	...
	<section class=" content mCustomScrollbar">
		<div class="rt_content">
			<div class="page_title">
				<h2 class="fl">添加一级类别</h2>
			</div>
			<form action="${ctx }/kind/added" method="post">
			 <table>
			 	<tr>
			 		<td>种类名称：</td>
			 		<td><input type="text" class="border" required="required" maxlength="10" name="kname"></td>
			 		<td style="color:red;">*,10字以内</td>
			 	</tr>
			 	<tr>
			 		<td>排序：</td>
			 		<td><input type="number" class="border"  required="required" value="0" name="ksort"></td>
